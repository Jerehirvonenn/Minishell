...
//check_flags: This function checks if a string contains only the -n flag. It returns 0 if valid (meaning it finds only -n), and 1 otherwise.
...
{
	int	i;
	bool	flag;//tracks whether the -n flag is present
